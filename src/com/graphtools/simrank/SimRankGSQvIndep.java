...
@GraphAnalyticTool(
name = "SimRankGSQvIndep",
description = "Compute SimRank based on graph sampling, and extract the random walk of query vertex" +
		"seperately."
)
public class SimRankGSQvIndep 
implements GenericGraphTool{
	...
	public void topksimrank(){
		...
		for(int i = 0; i < sampleNum; i++){
			...
			/* 2. sample a graph as other vertices' random walks */
			for(int vid = 0; vid < vertexMap.size(); vid++){
				indegrees[vid] = 0;
			}
			for(int vid = 0; vid < vertexMap.size(); vid++){
